                                    ...
                                    <table id="project-table" class="table text-nowrap mb-0 table-bordered border-top border-bottom project-list-main">
                                        ...
                                        @foreach($brands as $brand)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="mb-0 fs-14 fw-semibold">{{$brand->name}}</h6>
                                                </td>
                                                <td>
                                                    @if($brand->status == 1)
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-stretch">
                                                        <a class="btn btn-sm btn-outline-success border me-2" href="{{route('brand.edit',$brand->id)}}" data-bs-toggle="tooltip" data-bs-original-title="Edit">
