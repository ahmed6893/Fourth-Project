                                ...
                                <div class="table-responsive">
                                    <table id="project-table" class="table text-nowrap mb-0 table-bordered border-top border-bottom project-list-main">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{asset($customer->customer_image)}}" alt="NO Image" width="50" height="50">
                                            </td>
                                            <td>
                                                <h6 class="mb-0 fs-14 fw-semibold">{{$customer->first_name.$customer->last_name}}</h6>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if ($customer->order->count()>0)
                                                    {{ \Carbon\Carbon::parse($customer->order->last()->order_date)->format('d-m-y') }}
                                                @endif
                                            </td>
                                            <td>
