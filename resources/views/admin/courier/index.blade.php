                                ...
                                <div class="table-responsive">
                                    <table id="project-table" class="table text-nowrap mb-0 table-bordered border-top border-bottom project-list-main">
                                        ...
                                        <tr>
                                            ...
                                            <th class="bg-transparent border-bottom-0">Courier</th>
                                        ...
                                        @foreach($couriers as $courier)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{asset($courier->courier_image)}}" alt="Image" width="50" height="50">
                                                </td>
                                                <td>
                                                    <h6 class="mb-0 fs-14 fw-semibold">{{$courier->name}}</h6>
                                                </td>
                                                <td>
                                                    @if($courier->status == 1)
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-stretch">
                                                        <a class="btn btn-sm btn-outline-success border me-2" href="{{route('courier.edit',$courier->id)}}" data-bs-toggle="tooltip" data-bs-original-title="Edit">
