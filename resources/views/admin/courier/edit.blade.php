                            ...
                            <div class="card-body p-5 create-project-main">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input name="name" type="text" value="{{$courier->name}}" class="form-control text-dark" placeholder="Enter Courier Name">
                                    </div>
                                </div>
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" name="description" rows="4" placeholder="Write something...">{{$courier->description}}</textarea>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        @if($courier->courier_image)
                                            <div class="mt-2">
                                                <img src="{{ asset($courier->courier_image) }}" width="100" height="80" alt="Current Image">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="text-end">
                                    <button class="btn btn-primary" type="submit">
                                        <i class="fe fe-check-circle"></i> Update Courier
                                    </button>
                                </div>
                                </form>
                            </div>
