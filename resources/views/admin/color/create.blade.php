                ...
                <div class="page-header">
                    ...
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0);">All Colors</a></li>
                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div  class="card">
                            <div class="card-body p-5 create-project-main">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        <label class="form-label text-muted">Color Name:</label>
                                        <input name="name" type="text" class="form-control text-dark" placeholder="Enter Color Name">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-md-6">
