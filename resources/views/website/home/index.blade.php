                        ...
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-1.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-2.jpg" alt="product">
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-5.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-6.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-3.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-4.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-7.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-8.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-9.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-10.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-11.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="{{asset('/')}}website/assets/images/product-1/product-12.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
